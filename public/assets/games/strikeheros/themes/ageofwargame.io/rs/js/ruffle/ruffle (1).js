(() => {
  ...
  var e,
    ...
    t = {
      ...
      124: (e, n, t) => {
        e.exports = t.p + "55cb71776f36d1610186.wasm";
      },
      125: (e, n) => {
        Object.defineProperty(n, "__esModule", { value: !0 });
      },
      ...
      797: (e, n, t) => {
        e.exports = t.p + "4d8a0417dd69e48fd8eb.wasm";
      },
      836: (e, n) => {
        Object.defineProperty(n, "__esModule", { value: !0 });
      },
  ...
  (r.m = t),
    ...
    (r.u = (e) =>
      "core.ruffle." +
      { 482: "06cac76541461a7dd72a", 655: "6523cf91b70a5ad17d0c" }[e] +
      ".js"),
    (r.g = (function () {
  ...
  const l = {
    versionNumber: "0.2.0-nightly.2025.11.7",
    versionName: "0.2.0-nightly.2025.11.7",
    versionChannel: "nightly",
    buildDate: "2025-11-07T00:09:36.493Z",
    commitHash: "bbd45eab8a3c72d5b1629a363efdbf20cbde8a55",
  };
  var u;
  !(function (e) {
    ...
    switch (n.type) {
      ...
      case "select":
        return (function (e, { selector: n, variants: t, star: a }) {
          ...
          for (const n of t) {
            if (A(e, r, q(e, n.key))) return D(e, n.value);
          }
          return E(e, t, a);
        })(e, n);
      default:
  ...
  function T(e, n) {
    ...
    if (t instanceof S) return new S(t.valueOf(), { ...t.opts, ...O(n, $) });
    if (t instanceof C) return new S(t.toNumber(), { ...O(n, $) });
  ...
  function W(e, n) {
    ...
    if (t instanceof C || t instanceof S) return new C(t, O(n, I));
  ...
  class N {
    constructor(
      ...
      (this._terms = new Map()),
        ...
        (this._functions = { NUMBER: T, DATETIME: W, ...n }),
      ...
      function d() {
        ...
        if (t(J)) {
          ...
          if (r(se)) {
            ...
            if (K.test(a)) return { type: "func", name: a, args: o };
  ...
  Ee.content.appendChild(
    ...
    Ee.content.appendChild(
      (0, R.jsx)(function () {
        return (0,
        R.jsx)("div", { id: "context-menu-overlay", class: "hidden", children: (0, R.jsx)("ul", { id: "context-menu" }) });
      }, {})
    );
  const Fe = "application/x-shockwave-flash",
  ...
  try {
    if (
      ...
      e.endsWith(".js") || e.endsWith("/") || (e += "/"),
        (Oe = new URL(".", e)),
        ($e = Oe.protocol.includes("extension"));
    }
  } catch (e) {
  ...
  async function Ye(e) {
    null === Ge &&
      (Ge = (async function (e) {
        Re();
        const n = (await Promise.all([He(), Qe(), Ke(), Ze(), Je()])).every(
          Boolean
        );
        n ||
          console.log(
  ...
  class ln {
    ...
    displayRootMovieDownloadFailedMessage(e, n) {
      ...
      if (t && this.swfUrl && window.location.origin !== this.swfUrl.origin)
        ...
        const t = n.includes("HTTP Status is not OK:"),
          a = e ? new We(this.swfUrl) : new Ie(this.swfUrl, t);
        this.panic(a);
      }
    }
    displayMessageOrElement(e, n) {
      const t =
        ...
        r = (0, R.jsx)("div", {
          id: "message-overlay",
          children: (0, R.jsxs)("div", { class: "message", children: [t, a] }),
        });
  ...
  class qn extends Cn {
    ...
    connectedCallback() {
      super.connectedCallback(), (this.params = Fn(this));
      let e = null;
      if (
  ...
  class Vn {
    ...
    item(e) {
      return Nn(this, In, "f")[e >>> 0];
    }
    namedItem(e) {
      return Nn(this, Wn, "f")[e];
    }
    refresh() {}
    [((In = new WeakMap()), (Wn = new WeakMap()), Symbol.iterator)]() {
      return Nn(this, In, "f")[Symbol.iterator]();
    }
    get [Symbol.toStringTag]() {
      return "PluginArray";
    }
    get length() {
      return Nn(this, In, "f").length;
    }
  }
